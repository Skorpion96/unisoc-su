...
Yes, you are not dreaming. Today i want to present you an exploit for a system shell on com.sprd.engineermode app and since it is one of the trusted clients of cmd_skt i was also able to enter it as well. This socket is part of a service running as root (cmd_services), so yes, i’m glad to present you unisoc-su. Here a list of the trusted clients extracted from cmd_services binary with ghidra which shows com.sprd.engineermode is present:
