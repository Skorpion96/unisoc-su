...
Added now as well a small [poc app](https://github.com/Skorpion96/unisoc-su/tree/main/apks/unisoc-su%20poc), it's just an app with two buttons, one to connect to the cmd_services root shell, the other to connect to the system shell and a mini terminal so it's safe to use.
