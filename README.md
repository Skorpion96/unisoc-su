...
Also a two special cases which came later, them part of the inspirational CVEs list, the first one it's a reintroduced vulnerability, I'll add it here to make things cleaner: [CVE-2025-67264](https://www.cve.org/CVERecord?id=CVE-2025-67264) (Doogee com.sprd.engineermode bad patch on new unisoc models, covered [here](https://github.com/Skorpion96/unisoc-su/blob/main/CVE-2025-67264.md)), the second one which is a similar vulnerability affecting old unisoc models was covered [here](https://github.com/Skorpion96/unisoc-su/issues/4)
